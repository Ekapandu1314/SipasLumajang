 ...
 */
public class KepalaReguAbsenKamar extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kepala_regu_absen_kamar_view);
        ...
        tgl = (TextView)findViewById(R.id.tgl_kregukmr);
        ...
        verr = (TextView)findViewById(R.id.ver_kamar);

        kunci_l = (Button)findViewById(R.id.lock_kmr_l);
        kunci_p = (Button)findViewById(R.id.lock_kmr_p);
        kunci_s = (Button)findViewById(R.id.lock_kmr_s);

        kunci_l.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                lock_kamar(tanggal, "l", "1");
        ...
        listbloka.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                if (list_l == true)
                {
                    ...
                    {
                        alert.showAlertDialog(KepalaReguAbsenKamar.this, "Data Terkunci!", "Silahkan hubungi kepala lapas untuk edit data", false);
                    }
                    else if(lock.equalsIgnoreCase("2"))
                    {
                        alert.showAlertDialog(KepalaReguAbsenKamar.this, "Data Terkunci!", "Data telah diverifikasi oleh kepala lapas", false);
                    }
                    else if (lock.equalsIgnoreCase("0"))
                    {
                        final Dialog dialog = new Dialog(KepalaReguAbsenKamar.this);
        ...
        listblokwanita.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                alert.showAlertDialog(KepalaReguAbsenKamar.this, "Data Input Failed!", "Hanya penjaga wanita yang dapat memasukkan data kamar wanita", false);
    ...
    private class GetAbsen_Kamar extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = ProgressDialog.show(KepalaReguAbsenKamar.this, "Please wait...", "Silahkan tunggu");
        ...
        protected void onPostExecute(Void result) {
            ...
            // Dismiss the progress dialog
                ...
                ListAdapter adapter_bloka = new SimpleAdapter(
                        KepalaReguAbsenKamar.this, BlokA,
                ...
                ListAdapter adapter_blokb = new SimpleAdapter(
                        KepalaReguAbsenKamar.this, BlokB,
                        R.layout.list_item_kamar, new String[] {TAG_NO, TAG_JUMLAH, TAG_LOCK}, new int[] {R.id.kamar,
                        R.id.jumlah, R.id.lock2});

                ListAdapter adapter_blokwanita = new SimpleAdapter(
                        KepalaReguAbsenKamar.this, BlokWanita,
                        R.layout.list_item_kamar, new String[] {TAG_NO, TAG_JUMLAH, TAG_LOCK}, new int[] {R.id.kamar,
                        R.id.jumlah, R.id.lock2});

                ListAdapter adapter_bloksel = new SimpleAdapter(
                        KepalaReguAbsenKamar.this, BlokSel,
                        R.layout.list_item_kamar, new String[] {TAG_NO, TAG_JUMLAH, TAG_LOCK}, new int[] {R.id.kamar,
                        R.id.jumlah, R.id.lock2});
    ...
    private void submit_kamar(final String tanggal, final String blok, String no_kamar, String jumlah) {
        ...
        class LoginAsync extends AsyncTask<String, Void, String>{
            ...
            protected void onPostExecute(String result){
                ...
                {
                    //pDialog.dismiss();
                    alert.showAlertDialog(KepalaReguAbsenKamar.this, "Data tidak ditemukan!", "Cek koneksi internet anda kemudian coba lagi", false);
                }
    ...
    private void lock_kamar(final String tanggal, final String kode, String kunci) {
        ...
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(KepalaReguAbsenKamar.this, "Please wait", "Locking...");
    ...
    public void lockData_Kamar_perempuan(View view)
    {
        //list_p = false;
        //lock_kamar(tanggal, "p", "1");
        alert.showAlertDialog(KepalaReguAbsenKamar.this, "Data Input Failed!", "Hanya penjaga wanita yang dapat memasukkan data kamar wanita", false);
