 ...
 */
public class WanitaAbsen extends Activity {

    private Dialog pDialog;
    AlertDialogManager alert = new AlertDialogManager();

    // URL to get contacts JSON
    private static String url = "http://smpn1jatiroto.sch.id/lapaslmj/cektanggalp.php";
    ...
    private String[] status_spin = { "hadir", "Sakit", "Ijin", "Tugas","Libur", "Lainnya" };
    private String[] shiftt = { "P", "DH", "I", "PHL" };


    public String statusss;
    public String shifttt;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wanita_lihat_anggota);
        ...
        tgl = (TextView)findViewById(R.id.tgl_wanita);
        ...
        button_kunci = (Button)findViewById(R.id.lock_wnt);

        session = new Session(getApplicationContext());
        session.checkLogin();

        final ArrayAdapter<String> adapter_status = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item, status_spin);
        adapter_status.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        final ArrayAdapter<String> adapter_shift = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item, shiftt);
        ...
        lv = (ListView)findViewById(R.id.list_anggotaWanita);
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                if (klik == true) {
                    ...
                    if (lock.equalsIgnoreCase("1")) {
                        alert.showAlertDialog(WanitaAbsen.this, "Data Terkunci!", "Silahkan hubungi kepala lapas untuk edit data", false);
                    } else if (lock.equalsIgnoreCase("0")) {
                        final Dialog dialog = new Dialog(WanitaAbsen.this);
                        dialog.setContentView(R.layout.dialog_box_wanita);
                        dialog.setTitle("Masukkan status....");

                        TextView text = (TextView) dialog.findViewById(R.id.nama_dialog_box_wanita);
                        text.setText(nama);
                        final Button submit_status = (Button) dialog.findViewById(R.id.button_submit_dialog_box_wanita);

                        System.out.println(status_spin.length);

                        spinnerStatus = (Spinner) dialog.findViewById(R.id.spinner_status_wanita);
                        spinnerShift = (Spinner) dialog.findViewById(R.id.spinner_shift_wanita);

                        spinnerStatus.setAdapter(adapter_status);
                        spinnerShift.setAdapter(adapter_shift);
                        ...
                        spinnerStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parent, View view,
                                ...
                                String selState1 = (String) spinnerStatus.getSelectedItem();
                                statusss = selState1;
                            }
                        ...
                        spinnerShift.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parent, View view,
                                ...
                                String selState2 = (String) spinnerShift.getSelectedItem();
                                shifttt = selState2;
                            }
                        ...
                        submit_status.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                //String status_anggota = status.getText().toString();
                                    ...
                                    submit_status(tanggal, shifttt, nama, regu1, statusss);


                                ((TextView) view.findViewById(R.id.keterangan1)).setText(statusss);
                                ((TextView) view.findViewById(R.id.regu1)).setText(shifttt);
                        ...
                        alert.showAlertDialog(WanitaAbsen.this, "Input Failed!", "Anda belum waktunya absen", false);
                    } else if (lock.equalsIgnoreCase("2")) {
                        alert.showAlertDialog(WanitaAbsen.this, "Data Terkunci!", "Data telah diverifikasi oleh kepala lapas", false);
                    } else {
    ...
    private class GetAbsen extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = ProgressDialog.show(WanitaAbsen.this, "Please wait...", "Silahkan tunggu");
        ...
        class LoginAsync extends AsyncTask<String, Void, String>{
            ...
            protected String doInBackground(String... parameter) {
                ...
                try{
                    ...
                    HttpPost httpPost = new HttpPost("http://smpn1jatiroto.sch.id/lapaslmj/inputabsenp.php");
            ...
            protected void onPostExecute(String result){
                ...
                {
                    pDialog.dismiss();
                    alert.showAlertDialog(WanitaAbsen.this, "Data tidak ditemukan!", "Cek koneksi internet anda kemudian coba lagi", false);
                }
    ...
    private void lock_penjaga(final String kunci, String tanggal, String regu) {
        ...
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(WanitaAbsen.this, "Please wait", "Locking...");
