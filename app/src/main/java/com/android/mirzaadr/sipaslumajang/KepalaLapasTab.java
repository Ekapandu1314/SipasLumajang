 ...
 */
public class KepalaLapasTab extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent OneIntent = new Intent(this, CekPenjagaKepalaLapas.class);
        // Tab Content
        ...
        Intent TwoIntent = new Intent(this, CekKamarKepalaLapas.class);
        TwoSpec.setContent(TwoIntent);
        TwoSpec.setIndicator("Kamar");

        // Outbox Tab
        TabHost.TabSpec ThreeSpec = mTabHost.newTabSpec("THREE");
        Intent ThreeIntent = new Intent(this, SummaryKepalaLapas.class);
        ThreeSpec.setContent(ThreeIntent);
        ThreeSpec.setIndicator("Summary");

        // Adding all TabSpec to TabHost
        mTabHost.addTab(OneSpec); // Adding Inbox tab
        mTabHost.addTab(TwoSpec); // Adding Outbox tab
        mTabHost.addTab(ThreeSpec);
    }
