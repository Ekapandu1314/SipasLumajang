...
public class Session {
    ...
    private static final String PREF_NAME = "SDPAndroid";
     ...
     * */
    public void createLoginSession(String name, String team, String jabatan){
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        // user email id
        user.put(KEY_TEAM, pref.getString(KEY_TEAM, null));
