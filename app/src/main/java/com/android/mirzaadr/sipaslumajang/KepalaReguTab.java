 ...
 */
public class KepalaReguTab extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent OneIntent = new Intent(this, KepalaReguAbsenRegu.class);
        // Tab Content
        ...
        Intent TwoIntent = new Intent(this, KepalaReguAbsenKamar.class);
